...
frappe.provide("woocommerceconnector.woocommerce_setting");

frappe.ui.form.on("WooCommerce Setting", "onload", function(frm, dt, dn){
	frappe.call({
		method:"woocommerceconnector.woocommerceconnector.doctype.woocommerce_setting.woocommerce_setting.get_series",
		callback:function(r){
	...
	woocommerceconnector.woocommerce_setting.setup_queries(frm);
})

frappe.ui.form.on("WooCommerce Setting", "app_type", function(frm, dt, dn) {
	frm.toggle_reqd("api_key", (frm.doc.app_type == "Private"));
	frm.toggle_reqd("password", (frm.doc.app_type == "Private"));
})

frappe.ui.form.on("WooCommerce Setting", "refresh", function(frm){
...
$.extend(woocommerceconnector.woocommerce_setting, {
